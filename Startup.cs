...
namespace ContractorsIdentified
{
...
}).AddJwtBearer(options =>
{
  ...
  options.Audience = Configuration["Auth0:Audience"];
      ...
      {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "ContractorsIdentified", Version = "v1" });
      });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      if (env.IsDevelopment())
      {
        ...
        app.UseSwagger();
        app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ContractorsIdentified v1"));
